...
[![](https://img.shields.io/badge/Telegram-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://telegram.org/)

**Systems Engineer | Rust Enthusiast | Building Tools for AI Agents**

I'm passionate about building robust tools for AI agents and developer workflows in Rust. Currently focused on the **Model Context Protocol (MCP)** ecosystem, **LangGraph-inspired agent frameworks**, and **intelligent chatbot systems**.
...
### [telegram-bot](https://github.com/caiuschou/telegram-bot)
> Intelligent Telegram bot with LLM conversations

Feature-rich Telegram bot supporting streaming responses, RAG memory retrieval, and multiple storage backends (SQLite, LanceDB). Integrated with OpenAI/Zhipu AI models for smart conversations.

### [agora](https://github.com/caiuschou/agora)
> Agent registration and discovery system

Multi-agent coordination platform with shared protocol types, transport abstraction (in-process/WebSocket), and LangGraph integration for remote node execution.
...
| **Messaging** | ![Telegram](https://img.shields.io/badge/Telegram-2CA5E0?style=flat-square&logo=telegram) |
...
| [agora](https://github.com/caiuschou/agora) | ![GitHub stars](https://img.shields.io/github/stars/caiuschou/agora?style=social) | Rust | Multi-agent coordination |
| [workspace](https://github.com/caiuschou/workspace) | ![GitHub stars](https://img.shields.io/github/stars/caiuschou/workspace?style=social) | TypeScript | MCP architecture demo |
...
- **[MCP](https://modelcontextprotocol.io/)** - Building production-ready Rust tooling for Model Context Protocol
- **Agent Frameworks** - Creating reusable, stateful agent systems in Rust
- **Intelligent Bots** - Developing conversational AI with memory and context awareness
